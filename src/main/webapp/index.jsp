              ...
              <div class="control-group col-md-3">
                  <div class="form-row">
                      <div class="control-group col-md-6">
                          <label>房間數量</label>
                          <select class="custom-select" name="totalrooms" id="totalrooms" value= "${roomOrderVO.room_review}">
                      ...
                      <div class="control-group col-md-6 control-group-kid">
                          <label>人數</label>
                          <select class="custom-select" name="num_of_people" id="num_of_people" value= "${roomOrderVO.room_charge}">
                              <option value="1">1</option>
                              <option value="2">2</option>
                              <option value="3">3</option>
                              <option value="4">4</option>
