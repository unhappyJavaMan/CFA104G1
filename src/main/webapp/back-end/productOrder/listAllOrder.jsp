...
<jsp:useBean id="order_list_svc" scope="request" class="com.shopOrder.model.productOrderService"/>
...
<%-- 											<td><fmt:formatNumber type="number" maxFractionDigits="3" value="${OrderVO.o_discount_price}"/></td> --%>
