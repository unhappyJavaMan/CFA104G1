...
<%
RoomServiceOrderVO RoomServiceOrderVO = (RoomServiceOrderVO) request.getAttribute("RoomServiceOrderVO"); //EmpServlet.java (Concroller) 存入req的empVO物件 (包括幫忙取出的empVO, 也包括輸入資料錯誤時的empVO物件)
%>
	...
	<table class="table">
		...
		<tr>
			...
			<td><select name="service_order_status" size="0" >
				...
				<option value="true">未付款</option>
				<option value="false">已付款</option>
			</select></td>
		</tr>
		<tr>
			<td>服務訂單日期:</td>
