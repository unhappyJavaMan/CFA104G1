...
<%
  MealCategoryVO mealCategoryVO = (MealCategoryVO) request.getAttribute("mealCategoryVO");
%>
<%-- <%= empVo==null %>--${empVO.dptno}-- --%>
<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
<title>餐點類別資料新增 - addMealCategory.jsp</title>
...
<table>
	<tr>
		...
		<td><input type="TEXT" name="meal_category_id" size="45" 
			 value="<%= (mealCategoryVO==null)? "" : mealCategoryVO.getMeal_category_id()%>" /></td>
	</tr>
	<tr>
		<td>類別名稱:</td>
		<td><input type="TEXT" name="meal_category_name" size="45"
			 value="<%= (mealCategoryVO==null)? "" : mealCategoryVO.getMeal_category_name()%>" /></td>
	</tr>
