...
<head>
<meta charset="UTF-8">
<title>活動場次新增 - addActivitySession.jsp</title>
    ...
    <section class="content">
      <div class="col-lg-12 p-2">
		...
		<jsp:useBean id="activityService" scope="page" class="com.activity.model.ActivityService" />
				...
				<tr>
				<td>選擇活動:</td>
		  		<td><div><select name="activity_id">
		  		...
		  		<tr>
		  		<td>活動場次名稱:</td>
				<td><input type="text" name="activity_session_name" maxlength="20" value="<%= (activitySessionVO==null)? "" : activitySessionVO.getActivity_session_name()%>"/></td>  		
		  		</tr>
		  		
		  		<tr>
		  		<td>報名開始日期:</td>
		  		<td><input name="entered_started" id="f_date1" type="text"></td>
				</tr>
				
				<tr>
				<td>報名截止日期:</td>
		  		<td><input name="entered_end" id="f_date2" type="text" ></td>
		  		</tr>
		  		
		  		<tr>
		  		<td>活動日期起:</td>
		  		<td><input name="activity_started" id="f_date3" type="text"></td>
				</tr>
				
				<tr>
				<td>活動日期迄:</td>
		  		<td><input name="activity_end" id="f_date4" type="text"></td>
				</tr>
				
				<tr>
				<td>活動定價:</td>
				<td><input type="text" name="activity_price" value="<%= (activitySessionVO==null)? "" : activitySessionVO.getActivity_price()%>"/></td>
				</tr>
				
				<tr>
				<td><label for='activity_state' class='form-label'>活動狀態</label></td>
		            <td><div class='input-group mb-3'>
		                <input type='number' class='form-control' id='activity_state' min='0' max='4' autocomplete='off' name='activity_state' value='<%=(activitySessionVO == null) ? "" : activitySessionVO.getActivity_state()%>'>
		       ...
		       <td> 狀態備註: </td>
		        ...
		        <td><label for='activity_max_part' class='form-label'>活動人數上限</label></td>
		            <td><div class='input-group mb-3'>
		                <input type='number' class='form-control' id='activity_max_part' min='15' max='30' autocomplete='off' name='activity_max_part' value='<%=(activitySessionVO == null) ? "" : activitySessionVO.getActivity_max_part()%>'>
		        ...
		        <td><label for='activity_min_part' class='form-label'>活動人數下限</label></td>
		            <td><div class='input-group mb-3'>
		                <input type='number' class='form-control' id='activity_min_part' min='5' max='15' autocomplete='off' name='activity_min_part' value='<%=(activitySessionVO == null) ? "" : activitySessionVO.getActivity_min_part()%>'>
		                <span class='input-group-text'>人</span>
		         	</div></td>	
				</tr>
				<tr>
		        ...
		        <td><div class='input-group mb-3'>
		                <input type='number' class='form-control' id='product_status' min='0' max='1' autocomplete='off' name='product_status' value='<%=(activitySessionVO == null) ? "" : activitySessionVO.getProduct_status()%>'>
