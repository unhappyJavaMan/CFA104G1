...
<%@ include file= "/back-end/framework/header.file" %>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">QA修改</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
	...
	<tr>
		<td>顯示順序:</td>
		<td><input type="number" name="no" size="45" value="<%=qaListVO.getNo()%>" /></td>
	</tr>
	<tr>
		<td>問題:</td>
		<td><input type="TEXT" name="question" size="41"	value="<%=qaListVO.getQuestion()%>" /></td>
	</tr>
	<tr>
		<td>答覆:</td>
