...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-warning elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="<%=request.getContextPath()+"/resources/images/favicon.png" %>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">彌生管理後台</span>
    </a>
