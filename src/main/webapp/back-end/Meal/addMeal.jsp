...
%>
<%-- <%= empVo==null %>--${empVO.dptno}-- --%>
<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
<title>餐點資料新增 - addMeal.jsp</title>
...
<table>
	<tr>
		<td>餐點編號:</td>
		<td><input type="TEXT" name="meal_id" size="45" 
			 value="<%= (mealVO==null)? "" : mealVO.getMeal_id()%>" /></td>
	</tr>
<!-- 	<tr> -->
<!-- 		<td>類別編號:</td> -->
<!-- 		<td><input type="TEXT" name="meal_category_id" size="45" -->
<%-- 			 value="<%= (mealVO==null)? "12" : mealVO.getMeal_category_id()%>" /></td> --%>
<!-- 	</tr> -->
<jsp:useBean id="categorySvc" scope="page" class="com.mealCategory.model.MealCategoryService" />
	...
	<tr>
		<td>餐點描述:</td>
		<td><input type="TEXT" name="meal_description" size="45"
			 value="<%= (mealVO==null)? "好吃的" : mealVO.getMeal_description()%>" /></td>
	</tr>
	<tr>
		<td>餐點價格:</td>
		<td><input type="TEXT" name="meal_price" size="45"
			 value="<%= (mealVO==null)? "30" : mealVO.getMeal_price()%>" /></td>
	</tr>
	<tr>
		<td>餐點名稱:</td>
		<td><input type="TEXT" name="meal_name" size="45"
			 value="<%= (mealVO==null)? "" : mealVO.getMeal_name()%>" /></td>
	</tr>
	<tr>
		<td>餐點數量:</td>
		<td><input type="TEXT" name="meal_quantity" size="45"
			 value="<%= (mealVO==null)? "1" : mealVO.getMeal_quantity()%>" /></td>
	</tr>
	<tr>
		<td>餐點狀態:</td>
...
<!-- 	<tr> -->
<!-- 		<td>餐點狀態:</td> -->
<!-- 		<td><input type="TEXT" name="meal_status" size="45" -->
<%-- 			 value="<%= (mealVO==null)? "true" : mealVO.getMeal_status()%>" /></td> --%>
<!-- 	</tr> -->
	<tr>
		<td>餐點相片:</td>
		<td><img src="images/pr.png" width="100" height="100" border="0" id="showimg">
		<input type="file" name="meal_photo" size="45" id="flie" onchange="show(this)"/></td>
	</tr>
