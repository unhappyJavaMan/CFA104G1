...
@WebServlet("/ActivityPicReaderforid.do")
public class ActivityPicReaderforid extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			String id = req.getParameter("activity_photo_id");
			ResultSet rs = stmt.executeQuery(
//				"SELECT IMAGE FROM PICTURES WHERE PID = " + req.getParameter("PID"));
			    "SELECT ACTIVITY_PHOTO_FILE FROM ACTIVITY_PHOTO where activity_photo_id ="+id);
