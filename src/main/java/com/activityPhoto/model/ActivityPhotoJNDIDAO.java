...
public class ActivityPhotoJNDIDAO implements ActivityPhotoDAO_interface {
	...
	private static final String GET_FK_PIC = "SELECT * FROM ACTIVITY_PHOTO where ACTIVITY_ID = ?";
