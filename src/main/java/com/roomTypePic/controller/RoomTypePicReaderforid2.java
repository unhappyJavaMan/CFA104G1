...
public class RoomTypePicReaderforid2 extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			String id2 = req.getParameter("room_type_id");
			ResultSet rs = stmt.executeQuery(
//				"SELECT IMAGE FROM PICTURES WHERE PID = " + req.getParameter("PID"));
			    "SELECT room_pic FROM ROOM_TYPE_PIC WHERE room_photo_id ="+id + "and room_type_id = "+id2);
